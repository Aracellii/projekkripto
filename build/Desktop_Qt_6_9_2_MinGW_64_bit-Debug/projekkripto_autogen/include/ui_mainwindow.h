...
public:
    ...
    QLabel *label;
    QLabel *label_2;
    QPushButton *pushButtonCaesar_2;
    QPushButton *pushButtonViginere_2;
    QLabel *label_3;
    QPushButton *pushButtonCaesar_3;
    QWidget *page_2;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButtonCaesar_2 = new QPushButton(page);
        pushButtonCaesar_2->setObjectName("pushButtonCaesar_2");
        pushButtonCaesar_2->setGeometry(QRect(180, 220, 200, 40));
        pushButtonViginere_2 = new QPushButton(page);
        pushButtonViginere_2->setObjectName("pushButtonViginere_2");
        pushButtonViginere_2->setGeometry(QRect(410, 220, 200, 40));
        label_3 = new QLabel(page);
        label_3->setObjectName("label_3");
        label_3->setGeometry(QRect(320, 290, 171, 20));
        pushButtonCaesar_3 = new QPushButton(page);
        pushButtonCaesar_3->setObjectName("pushButtonCaesar_3");
        pushButtonCaesar_3->setGeometry(QRect(270, 340, 261, 40));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButtonCaesar_2->setText(QCoreApplication::translate("MainWindow", "Modern", nullptr));
        pushButtonViginere_2->setText(QCoreApplication::translate("MainWindow", "Modern", nullptr));
        label_3->setText(QCoreApplication::translate("MainWindow", "Metode Algoritma Super", nullptr));
        pushButtonCaesar_3->setText(QCoreApplication::translate("MainWindow", "Metode Kriptografi gabungan", nullptr));
